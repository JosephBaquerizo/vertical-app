...
export default function Arte() {
    ...
    const savePDF = () => {
        ...
        doc.html(certificate, {
            ...
            callback: function(doc) {
                doc.output('save', { filename: 'fichero-pdf.pdf' });
            }
        })
    }
            ...
            <main className={styles.art}>
                ...
                <div id='doc' className={styles.document}>
                    ...
                    <section className={styles.table1}>
                        <table>
                            <tr>
                                <td className={styles.image} rowspan='11'><Image src='/frontal.png' alt='' width={500} height={500}/></td>
                            </tr>
                            <tr>
                    ...
                    <section className={styles.extraPics}>
                        <div className={styles.left}>
                            <table>
                                <tr>
                                    <td className={styles.image}><Image src='/reverso.png' alt='' width={120} height={150}/></td>
                                </tr>
                            </table>
                            <span style={{'font-size': '10px', 'color': 'grey'}}>Reverso</span>
                        </div>
                        <div className={styles.right}>
                            <Image src='/firma.png' alt='' width={120} height={150}/>
                            <span style={{'font-size': '10px', 'color': 'grey'}}>Inscripción / Firma</span>
                        </div>
                    </section>
                    ...
                    <section className={styles.datosExtra}>
                        <table>
                            ...
                            <tr>
                                ...
                                <td className={cls(styles.greyFont, styles.secondColumn)}>2022-09-16</td>
